...
export const metadata: Metadata = {
  title: 'Notes — Jeff Mboya',
  description: 'Writing on hardware, software, and the space between.',
}
  ...
  return (
    <div className="pb-20">
      ...
      <div className="mb-10">
        ...
        <h1 className="text-[32px] font-bold tracking-tight mb-3" style={{ color: 'var(--foreground)' }}>Notes</h1>
      ...
      {notes.length === 0 ? (
        <p className="text-[14px]" style={{ color: 'var(--muted-dim)' }}>No notes yet — check back soon.</p>
      ) : (
