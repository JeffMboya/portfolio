  ...
  return (
    <div className="pb-24 max-w-[680px]">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-[34px] font-bold tracking-tight mb-4" style={{ color: 'var(--foreground)' }}>
          What I&apos;m doing now
        </h1>
      ...
      <div className="flex flex-col gap-12">
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            <span className="text-[13px] uppercase tracking-widest font-medium" style={{ color: 'var(--foreground)' }}>Building</span>
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            <span className="text-[13px] uppercase tracking-widest font-medium" style={{ color: 'var(--foreground)' }}>Learning</span>
            <div className="flex-1 h-px" style={{ backgroundColor: 'var(--border)' }} />
          </div>
          <div className="flex flex-col gap-4">
            <p className="text-[17px] leading-relaxed" style={{ color: 'var(--muted)' }}>
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            <span className="text-[13px] uppercase tracking-widest font-medium" style={{ color: 'var(--foreground)' }}>Thinking About</span>
            <div className="flex-1 h-px" style={{ backgroundColor: 'var(--border)' }} />
          </div>
          <div className="flex flex-col gap-4">
            <p className="text-[17px] leading-relaxed" style={{ color: 'var(--muted)' }}>
            ...
            <div
              className="rounded-lg px-4 py-3.5 text-[16px] font-medium leading-relaxed"
              style={{
