...
slug: octavia
description: Two and a half years at Africa's leading direct air capture startup. Co-developed the R&D roadmap that secured $3.1M in Series A funding. Led the PCB and ESP32 migration that cut CAPEX 63%. Drove an 83% cycle time reduction and 3.6x CO₂ throughput improvement on the pilot plant.
stack:
  - Siemens S7-1200
  - TIA Portal
  - ESP32
