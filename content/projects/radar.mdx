...
Radar is inspired by [DAGverse](https://arxiv.org/abs/2603.25293), which argues that the most useful thing you can extract from a paper isn't its conclusion — it's the dependency structure that makes the conclusion usable. Which concepts cause which other concepts? What enables what?
