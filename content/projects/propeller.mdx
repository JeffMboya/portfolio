...
title: Propeller
slug: propeller
description: A distributed WebAssembly task execution platform. Edge agents written in Rust subscribe via MQTT, receive task dispatch from a Go manager, and execute sandboxed WASM binaries — with OCI registry fetch, HTTP delivery, and platform attestation support.
stack:
  - Go
  - Rust
  - WebAssembly
