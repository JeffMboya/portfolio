...
<img src="/hardware/baseboard.webp" alt="S0 Baseboard — HanRun Ethernet jack, SD card slot, power regulation, and S0 edge connector" style={{width: '100%', maxWidth: '480px', borderRadius: '8px', margin: '12px 0 20px'}} />
...
## Other Hardware I've Built

The gateways sit alongside a wider body of hardware work — boards designed and fabricated for different sensing and control problems.

<PhotoGrid
  srcs="/hardware/esp32-control.jpg, /hardware/co2-sensor.jpg, /hardware/rtd.jpg"
  captions="ESP32 control module — screw terminals, power regulation, and relay outputs for industrial control|CO2 sensor module — ESP32-S3, electrochemical gas sensor, and field I/O terminals|32-channel RTD module — per-channel signal conditioning, multiplexed ADC, and dense terminal block layout"
/>

The 32-channel RTD module was one of the denser routing challenges — matching 32 independent signal paths with consistent trace impedance while keeping the per-channel conditioning circuits identical across the board.

<video
  src="/hardware/rtd.mov"
  controls
  muted
  playsInline
  style={{width: '100%', borderRadius: '8px', margin: '12px 0 20px'}}
