---
title: "Cloud-Edge Computing: Why Routing Everything Through the Cloud Is Quietly Killing Your IoT…"
slug: cloud-edge-computing-why-routing-everything-through-the-cloud-is-quietly-killing
description: "Cloud-Edge Computing: Why Routing Everything Through the Cloud Is Quietly Killing Your IoT Architecture | Blog You are running a factory with 5,000 sensors reporting temperature, vibration, pressure, "
date: "2026-03"
category: "tech"
tags: ["cloud-computing", "orchestration", "iot", "wasm", "edge-computing"]
source: "https://medium.com/abstract-machines-blog/cloud-edge-computing-why-routing-everything-through-the-cloud-is-quietly-killing-your-iot-d2409972bc64"
---

### Cloud-Edge Computing: Why Routing Everything Through the Cloud Is Quietly Killing Your IoT Architecture | Blog
...
The runs centrally — on a gateway, industrial PC, or any Linux machine. They register with the Manager at startup, listen for task commands, execute Wasm binaries using the Wasmtime runtime, and report results back. **Proplets need only outbound MQTT connectivity.** No open firewall rules. No VPN. No inbound ports.
...
_Originally published at_ [_https://www.absmach.eu_](https://www.absmach.eu/blog/cloud-edge-computing-explained/)_._
